...
;"Num1" et "Num2", demandent a l'utilisateur d'entrer les deux nombres sur lesquels il souhaite effectuer l'opération selectionnee.
...
view32 proc
    ...
    afficher: 
        add dl,30h ;Transforme en caractï¿½re [0,9] -> ["0","9"]
        mov ah,02h ;Afficher
        int 21h 
